<?php
session_start();
$pass='egor'; // Пароль для входа в Админку
...
<br><br><br><p><a href="http://google.com" target="_blank">Видео инструкция по админке тут —  просто нажмите по этому тексту.</a><br><br>
		<p>Есть вопросы? Нужно что бы изминения внес я? <p>Тогда <a href="http://google.com" target="_blank">вот мой сайт — google.com просто нажмите по этому тексту.</a> <p>Так же, можете написать мне на почту through8space@gmail.com</div>');
};
